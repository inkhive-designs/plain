...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 grid plain'); ?>>
    ...
    <div class="out-thumb col-md-6 col-sm-6">
        <header class="entry-header">
            ...
            <span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Countinue Reading','plain'); ?></a></span>
        </header><!-- .entry-header -->
    </div><!--.out-thumb-->

    <div class="featured-thumb col-md-6 col-sm-6">
        <?php if (has_post_thumbnail()) : ?>
            <a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>"><?php the_post_thumbnail('plain-pop-thumb'); ?></a>
        <?php else: ?>
